...
execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s red_dye 0
execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 3
execute as @a[scores={Mode=2}] run scoreboard players set $Gamemode Mode 6
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1


item replace entity @a inventory.11 with minecraft:acacia_door[custom_name='["",{"text":"Deathmatch","italic":false}]']
execute if score U_Lives Unlocks matches 0 run item replace entity @a inventory.13 with minecraft:barrier[custom_name='["",{"text":"Locked","italic":false,"bold":true,"color":"red"}]']
execute if score U_Lives Unlocks matches 1 run item replace entity @a inventory.13 with minecraft:red_dye[custom_name='["",{"text":"Lives","italic":false}]']
item replace entity @a inventory.15 with minecraft:structure_void[custom_name='["",{"text":"To Be Added","italic":false}]']
