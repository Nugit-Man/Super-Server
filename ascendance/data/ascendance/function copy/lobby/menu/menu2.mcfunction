...
scoreboard players set $Team Mode 1
...
execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 3
execute as @a[scores={Mode=2}] run scoreboard players set $Gamemode Mode 1
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1

execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s acacia_hanging_sign 0
execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 3
execute as @a[scores={Mode=2}] run scoreboard players set $Gamemode Mode 2
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1

execute as @a[scores={Mode=1},tag=!Advancement-large_incline] run execute store result score @s Mode run clear @s armor_stand 0
execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 3
execute as @a[scores={Mode=2}] run scoreboard players set $Gamemode Mode 3
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1

execute as @a[scores={Mode=1},tag=Advancement-large_incline] run execute store result score @s Mode run clear @s armadillo_scute 0
execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 3
execute as @a[scores={Mode=2}] run scoreboard players set $Gamemode Mode 3
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1
...
item replace entity @a inventory.11 with minecraft:acacia_door[custom_name='["",{"text":"Deathmatch","italic":false}]']
item replace entity @a inventory.13 with minecraft:acacia_hanging_sign[custom_name='["",{"text":"Kings Crown","italic":false}]']
item replace entity @a[tag=!Advancement-large_incline] inventory.15 with minecraft:armor_stand[custom_name='["",{"text":"King Of The Hill","italic":false}]']
item replace entity @a[tag=Advancement-large_incline] inventory.15 with minecraft:armadillo_scute[custom_name='["",{"text":"King Of The Hill","italic":false}]']
