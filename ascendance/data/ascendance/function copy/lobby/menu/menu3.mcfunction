...
execute if score $Start Mode matches 0 run execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 2
...
execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s dirt_path 0
execute if score $Start Mode matches 0 run execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 4
execute if score $Start Mode matches 0 run execute as @a[scores={Mode=2}] run scoreboard players set $Map Mode 0
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1


execute if score $Start Mode matches 0 run execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s lime_concrete 0
...
execute if score $Start Mode matches 1.. run execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s black_concrete 0
...
execute if score $Start Mode matches 1.. run execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s leather_helmet 0
execute as @a[scores={Mode=2}] run team join Red @s
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1


execute as @a[scores={Mode=1}] run execute store result score @s Mode run clear @s fermented_spider_eye 0
execute if score $Start Mode matches 0 run execute as @a[scores={Mode=2}] run scoreboard players set $Menu Mode 12
tag @a[scores={Mode=2}] add select
scoreboard players set @a[scores={Mode=2}] Mode -1
...
execute if score $Gamemode Mode matches 1 run item replace entity @a inventory.14 with minecraft:fermented_spider_eye[custom_name='["",{"text":"Alternates","italic":false}]']
execute if score $Gamemode Mode matches 6 run item replace entity @a inventory.14 with minecraft:fermented_spider_eye[custom_name='["",{"text":"Alternates","italic":false}]']
execute if score $Gamemode Mode matches 2..5 run item replace entity @a inventory.14 with minecraft:structure_void[custom_name='["",{"text":"To Be Added","italic":false}]']
