...
#Get name of map
execute if score $Parse AS_Map matches 0 run data modify storage ascendance:multiplayer map_name set value "null"
...
execute if score $Parse AS_Map matches 6..9 run data modify storage ascendance:multiplayer map_name set value "null"
...
execute if score $Parse AS_Map matches 14 run data modify storage ascendance:multiplayer map_name set value "null"


#Get name of map
execute if score $Parse AS_Map matches 0 run data modify storage ascendance:multiplayer map_spawn set value "null"
...
execute if score $Parse AS_Map matches 6..9 run data modify storage ascendance:multiplayer map_spawn set value "null"
...
execute if score $Parse AS_Map matches 14 run data modify storage ascendance:multiplayer map_spawn set value "null"
