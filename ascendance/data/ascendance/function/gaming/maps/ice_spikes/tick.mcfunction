execute as @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1}] run scoreboard players operation @s AS_Map_IceSpikes += @s AS_Kills
...
#Spawn points
execute at @e[type=marker,limit=1,sort=random,tag=AS_Spawn_IceSpikes] run spawnpoint @r[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1}]
