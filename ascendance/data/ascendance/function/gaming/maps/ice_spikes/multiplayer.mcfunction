#Winner
execute as @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1}] if score @s AS_Map_IceSpikes >= $Par AS_Map_IceSpikes run tag @s add AS_Winner
...
#actionbar
execute as @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1}] run title @s actionbar [{text:"Score: "},{score:{"objective":"AS_Map_IceSpikes","name":"@s"}},{text:"/"},{score:{objective:AS_Map_IceSpikes,name:"$Par"}},{text:", Spread: "},{score:{"objective":"AS_Spread","name":"@s"}},{text:", Winning: "},{selector:"@a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1},tag=AS_Winning]"}]
...
#Deal with crown
execute as @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Deaths=1..},tag=AS_Crown] run tag @a[limit=1,tag=!AS_Crown,scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Kills=1..}] add AS_Crown
item replace entity @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Deaths=1..},tag=AS_Crown] armor.head with air
execute as @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Deaths=1..},tag=AS_Crown] run item replace entity @a[limit=1,tag=!AS_Crown,scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Kills=1..}] armor.head with golden_helmet[enchantments={binding_curse:1},unbreakable={},enchantment_glint_override=false,tooltip_display={hidden_components:[enchantments,unbreakable]}]
tag @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Deaths=1..},tag=AS_Crown] remove AS_Crown 
effect give @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2},tag=AS_Crown] glowing infinite 0 true

#Check for no crown
execute unless entity @a[scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2},tag=AS_Crown] run tag @r[limit=1,tag=!AS_Crown,scores={MAIN_Game=1,AS_Map=11,AS_Mode=1,AS_Gamemode=2,AS_Countdown=16..}] add AS_Get_Crown
