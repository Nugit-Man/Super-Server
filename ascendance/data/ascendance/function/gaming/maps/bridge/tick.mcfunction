...
execute if score MAIN_2s MAIN_Time matches 1 run execute as @a[scores={MAIN_Game=1,AS_Map=13,AS_Mode=1,AS_Gamemode=2},tag=AS_Crown] run scoreboard players add @s AS_Map_Bridge 1
