...
item replace entity @s inventory.1 with minecraft:paper[custom_name={text:"Small Maps",italic:false},lore=[{text:"Click for a random small map",italic:false}]]
item replace entity @s inventory.2 with minecraft:sandstone[custom_name={text:"Desert Tomb",italic:false}]
item replace entity @s inventory.3 with minecraft:white_concrete[custom_name={text:"The Cube",italic:false}]
item replace entity @s inventory.4 with minecraft:polished_andesite[custom_name={text:"The Club",italic:false}]
...
item replace entity @s inventory.10 with minecraft:paper[custom_name={text:"Medium Maps",italic:false},lore=[{text:"Click for a random medium map",italic:false}]]
item replace entity @s inventory.11 with minecraft:black_concrete[custom_name={text:"Tabletop",italic:false}]
item replace entity @s inventory.12 with minecraft:blue_ice[custom_name={text:"Ice Spikes",italic:false}]
item replace entity @s inventory.13 with minecraft:chiseled_sandstone[custom_name={text:"Colosseum",italic:false}]
...
item replace entity @s inventory.19 with minecraft:paper[custom_name={text:"Large Maps",italic:false},lore=[{text:"Click for a random large map",italic:false}]]
item replace entity @s inventory.20 with minecraft:polished_andesite[custom_name={text:"Brutalism",italic:false}]
item replace entity @s inventory.21 with minecraft:grass_block[custom_name={text:"Jungle Pikes",italic:false}]
item replace entity @s inventory.22 with minecraft:granite[custom_name={text:"Bridge",italic:false}]
