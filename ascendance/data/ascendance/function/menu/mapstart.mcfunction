...
execute as @a[scores={MAIN_Game=1,AS_Countdown=11,AS_Gamemode=100}] run schedule function ascendance:gaming/spawn_first 10t
execute as @a[scores={MAIN_Game=1,AS_Countdown=11,AS_Gamemode=100}] run schedule function ascendance:gaming/remove_creepers 9t