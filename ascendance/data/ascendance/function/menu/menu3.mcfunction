...
item replace entity @s inventory.13 with minecraft:golden_helmet[custom_name={text:"King's crown",italic:false},lore=[{text:"Wear the crown to gain points",italic:false},{text:"Kill the player with the crown to steal it",italic:false}]]
