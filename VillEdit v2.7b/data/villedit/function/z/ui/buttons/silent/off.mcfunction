...
item replace block ~ ~ ~ container.21 with goat_horn[custom_name='{"text":"Silent","color":"aqua","italic":false}',lore=['[{"text":"Current value: ","color":"green","italic":false},{"text": "OFF","color":"gray","italic":false}]'],custom_data={ve_ui:1b},hide_additional_tooltip={}]