...
item replace entity @s inventory.9 with minecraft:diamond[minecraft:custom_model_data={strings:['Kanye']},custom_name={text:"Kanye",italic:false}]
...
item replace entity @s inventory.15 with minecraft:diorite[custom_name={text:"Random Item Challenge",italic:false}]
item replace entity @s inventory.16 with minecraft:bow[custom_name={text:"Ascendance",italic:false}]
item replace entity @s inventory.17 with minecraft:egg[custom_name={text:"Mob Madness",italic:false}]
...
scoreboard players set @a[scores={MAIN_Game=0}] MAIN_Select 0
execute as @a[scores={MAIN_Game=0}] store result score @s MAIN_Select run clear @s egg 0
tag @a[scores={MAIN_Game=0,MAIN_Select=2}] add GoTo_Mob_Madness
clear @a[scores={MAIN_Game=0,MAIN_Select=2}]
