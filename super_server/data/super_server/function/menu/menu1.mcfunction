...
item replace entity @s inventory.9 with minecraft:mace[custom_name={text:"Mace Masters",italic:false},tooltip_display={hidden_components:["attribute_modifiers"]},rarity="common"]
...
item replace entity @s inventory.15 with minecraft:grass_block[custom_name={text:"Skyblock",italic:false}]
item replace entity @s inventory.16 with minecraft:air
item replace entity @s inventory.17 with minecraft:bow[custom_name={text:"Ascendance",italic:false}]
