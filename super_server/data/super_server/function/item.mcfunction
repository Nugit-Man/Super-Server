...
#Final Island Axes
execute as @s[scores={MAIN_Game=2}] if items entity @s weapon.mainhand *[custom_data~{FI_Emerald_Axe:1b}] run function final_island:abilities/emerald_axe
execute as @s[scores={MAIN_Game=2}] if items entity @s[scores={FI_Mana_Cooldown_diamond_axe=1..}] weapon.mainhand *[custom_data~{FI_Diamond_Axe:1b}] run function final_island:abilities/diamond_axe
execute as @s[scores={MAIN_Game=2}] if items entity @s[scores={FI_Mana_Cooldown_stone_axe=1..}] weapon.mainhand *[custom_data~{FI_Stone_Axe:1b}] run function final_island:abilities/diamond_axe
