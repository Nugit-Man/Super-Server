execute at @s[tag=MM_Blue] run summon armor_stand ^ ^ ^1 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["MM_Chicken_New","MM_Chicken_Ride","MM_Blue"],Passengers:[{id:"minecraft:item_display",Tags:["MM_Chicken_Egg","MM_Chicken_New","MM_Blue"],item:{id:"minecraft:egg",count:1}}]}
...
scoreboard players remove @s MM_Chicken_Song_Bar 20
scoreboard players set @s MM_Chicken_Song_Bar_Cooldown 12
scoreboard players set @s MM_Chicken_Main_Cooldown 15
