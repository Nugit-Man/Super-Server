execute if entity @s[tag=MM_Ice_Pinball_Blue] run summon item_display ~ ~ ~ {Tags:[MM_Ice_Pinball,MM_Ice_Pinball_New,MM_Ice_Pinball_Blue],item:{id:"minecraft:blue_ice",count:1},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[.1f,.1f,.1f]}}
execute if entity @s[tag=MM_Ice_Pinball_Red] run summon item_display ~ ~ ~ {Tags:[MM_Ice_Pinball,MM_Ice_Pinball_New,MM_Ice_Pinball_Red],item:{id:"minecraft:blue_ice",count:1},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[.1f,.1f,.1f]}}
