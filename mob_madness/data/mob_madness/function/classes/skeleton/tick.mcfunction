...
scoreboard players add @s[scores={MM_Skeleton_Bone_Phase=0,MM_Skeleton_Bone_Charge=..124,MM_Skeleton_Arrow_Cooldown=..15}] MM_Skeleton_Bone_Charge 1
scoreboard players remove @s[scores={MM_Skeleton_Bone_Phase=1..3,MM_Skeleton_Bone_Charge=1..}] MM_Skeleton_Bone_Charge 1
...
execute at @s[scores={MM_Skeleton_Bone_Phase=1..}] run particle minecraft:soul_fire_flame ~ ~1 ~ 0.2 0.2 0.2 0.01 10 normal
...
execute if score @s MM_Skeleton_Bone_Phase matches 3 run function mob_madness:classes/skeleton/bar/phase3
