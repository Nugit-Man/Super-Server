...
$data modify storage parkourtrial:scratchpad display_splits append value {type:"nbt",storage:"parkourtrial:course_info",nbt:"split_names[$(count)]",interpret:true}
data modify storage parkourtrial:scratchpad display_splits append value ": "
# Format time
...
$data modify storage parkourtrial:scratchpad display_splits append value {type:"nbt",storage:"parkourtrial:record_info",nbt:"record.formatted_splits[$(count)]",interpret:true}