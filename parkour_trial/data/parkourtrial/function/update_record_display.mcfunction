...
"Best Time: ",\
{type:"nbt",bold:true,storage:"parkourtrial:record_info",nbt:"record.formatted_time",interpret:true},\
" by ",\
{type:"nbt",storage:"parkourtrial:record_info",nbt:"record.player_name",interpret:true},\
"\n",\
]
