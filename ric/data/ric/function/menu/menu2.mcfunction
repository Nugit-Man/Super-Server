...
item replace entity @s inventory.13 with minecraft:barrier[custom_name={text:"Leave Pillars",italic:false}]
...
execute as @a[scores={MAIN_Game=7}] store result score @s RIC_Select run clear @s barrier 0
scoreboard players set @a[scores={MAIN_Game=7,RIC_Select=2}] RIC_Menu 0
