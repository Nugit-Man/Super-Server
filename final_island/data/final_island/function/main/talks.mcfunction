...
#W dirt munchers
execute as @e[type=interaction,limit=1,tag=FI_Village_Dirt] on target run execute store result score @s FI_Villager_Talk run random value 12..16
...
execute as @e[type=interaction,limit=1,tag=FI_Quest_Village_Bookshelf] on target run execute store result score @s FI_Villager_Check run clear @s iron_block 0
