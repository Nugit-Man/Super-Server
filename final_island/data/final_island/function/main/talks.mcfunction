...
#W dirt munchers
execute as @e[type=interaction,limit=1,tag=FI_Village_Dirt] on target run execute store result score @s[tag=!FI_Quest_Village_Anvil,tag=!FI_Quest_Village_Anvil_Start] FI_Villager_Talk run random value 12..16
