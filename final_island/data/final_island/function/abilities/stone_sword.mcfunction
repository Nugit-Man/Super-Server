...
execute at @e[tag=FI_Ability_Stone_Cold] run effect give @e[distance=..2.5,tag=!FI_Stone_Cold] slowness 10 2 true
execute at @e[tag=FI_Ability_Stone_Cold] run execute as @e[distance=..2.5] run damage @s 6 freeze
