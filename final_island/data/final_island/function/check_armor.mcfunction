...
execute as @a[tag=FI_Armor_Set_Tuff,scores={MAIN_Game=2}] run attribute @s knockback_resistance base set 0.8
execute as @a[tag=!FI_Armor_Set_Tuff,scores={MAIN_Game=2}] run attribute @s knockback_resistance base reset
...
execute as @a[scores={MAIN_Game=2}] if items entity @s armor.head *[custom_data~{FI_Zombie_Crown:1b}] run attribute @s max_health base set 2
