...
scoreboard players add @a[scores={MAIN_Game=2,FI_Armor_Set_Check=4},tag=!FI_Armor_Set_Lapis] FI_Mana_Max 100
tag @a[scores={MAIN_Game=2,FI_Armor_Set_Check=4}] add FI_Armor_Set_Lapis
scoreboard players remove @a[scores={MAIN_Game=2,FI_Armor_Set_Check=..3},tag=FI_Armor_Set_Lapis] FI_Mana_Max 100
tag @a[scores={MAIN_Game=2,FI_Armor_Set_Check=..3}] remove FI_Armor_Set_Lapis
