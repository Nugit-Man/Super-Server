...
execute if score FI_Zombie_Deepslate FI_Item_Cap matches 0..12 in final_island:game if score FI_Zombie_Deepslate FI_Random matches 1 at @e[type=marker,limit=1,sort=random,tag=FI_Zombie_Deepslate_Spawner] run summon zombie ~ ~ ~ {Tags:[FI_Zombie_Deepslate,FI_Zombie_Armor_Deepslate],ArmorDropChances:[0f,0f,0f,0f],MainhandDropChance:0f}
