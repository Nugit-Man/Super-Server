...
execute if score FI_lapis FI_Item_Cap matches 0 in final_island:game if score FI_lapis FI_Random matches 1..10 run summon item 68976 157 32 {Item:{id:"minecraft:lapis_lazuli",count:4b}}
execute if score FI_lapis FI_Item_Cap matches 0 in final_island:game if score FI_lapis FI_Random matches 10..20 run summon item 68979 158 54 {Item:{id:"minecraft:lapis_lazuli",count:4b}}
execute if score FI_lapis FI_Item_Cap matches 0 in final_island:game if score FI_lapis FI_Random matches 20..30 run summon item 69003 161 54 {Item:{id:"minecraft:lapis_lazuli",count:4b}}
