...
execute if score FI_emerald FI_Item_Cap matches 0 in final_island:game if score FI_emerald FI_Random matches 71..100 run schedule function final_island:spawn_items/caves/emerald 340t