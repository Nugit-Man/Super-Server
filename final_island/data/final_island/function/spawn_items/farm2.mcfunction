...
execute as @e[type=item,nbt={Item:{id:"minecraft:melon",count:64}}] run scoreboard players add FI_melon FI_Item_Cap 1
...
execute if score FI_melon FI_Item_Cap matches 0 in final_island:game if score FI_melon FI_Item_Counter matches 1 if score FI_melon FI_Random matches 1..20 run summon item -85 2 46 {Item:{id:"minecraft:melon",count:1b}}
