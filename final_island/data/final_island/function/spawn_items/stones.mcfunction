...
execute as @e[type=item,nbt={Item:{id:"minecraft:stone",count:64}}] run scoreboard players add FI_stone FI_Item_Cap 1
...
execute if score FI_stone FI_Item_Cap matches 0 in final_island:game if score FI_stone FI_Item_Counter matches 1 run summon item -13 -33 -39 {Item:{id:"minecraft:stone",count:1b}}
...
schedule function final_island:spawn_items/stones 12t