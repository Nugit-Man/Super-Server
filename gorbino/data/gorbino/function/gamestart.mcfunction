...
give @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_lava] magma_block[custom_name=[{"text":"Lava","italic":false,"color":"white"}],food={nutrition:0,saturation:0,can_always_eat:1b},consumable={consume_seconds:0.5,animation:block,sound:"entity.generic.burn",has_consume_particles:0b},use_cooldown={seconds:10}]
...
give @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_invis] glass_pane[custom_name=[{"text":"Invisability","italic":false}],food={nutrition:0,saturation:0,can_always_eat:1b},consumable={consume_seconds:0.05,sound:"entity.enderman.teleport",has_consume_particles:0b},use_cooldown={seconds:25}]
