...
item replace entity @a[scores={GB_Mode=1},tag=GB_simple_armor] armor.chest with minecraft:leather_chestplate[unbreakable={show_in_tooltip:false}]
item replace entity @a[scores={GB_Mode=1},tag=GB_simple_armor] armor.legs with minecraft:leather_leggings[unbreakable={show_in_tooltip:false}]
item replace entity @a[scores={GB_Mode=1},tag=GB_simple_armor] armor.feet with minecraft:leather_boots[unbreakable={show_in_tooltip:false}]
...
item replace entity @a[scores={GB_Mode=1},tag=GB_chain_armor] armor.chest with minecraft:chainmail_chestplate[unbreakable={show_in_tooltip:false}]
item replace entity @a[scores={GB_Mode=1},tag=GB_chain_armor] armor.legs with minecraft:chainmail_leggings[unbreakable={show_in_tooltip:false}]
execute as @a[tag=GB_chain_armor] run item replace entity @s[scores={GB_Mode=1},tag=GB_chain_armor] armor.feet with minecraft:chainmail_boots[unbreakable={show_in_tooltip:false}]
...
item replace entity @a[scores={GB_Mode=1},tag=GB_heavy_armor] armor.chest with minecraft:iron_chestplate[unbreakable={show_in_tooltip:false}]
item replace entity @a[scores={GB_Mode=1},tag=GB_heavy_armor] armor.legs with minecraft:iron_leggings[unbreakable={show_in_tooltip:false}]
item replace entity @a[scores={GB_Mode=1},tag=GB_heavy_armor] armor.feet with minecraft:iron_boots[unbreakable={show_in_tooltip:false}]
...
give @a[scores={GB_Mode=1},tag=GB_lumberjack] iron_axe[unbreakable={show_in_tooltip:false}]
give @a[scores={GB_Mode=1},tag=GB_archer] bow[unbreakable={show_in_tooltip:false}]
give @a[scores={GB_Mode=1},tag=GB_archer] arrow 3
scoreboard players set @a[scores={GB_Mode=1},tag=GB_archer] GB_Arrow 0
give @a[scores={GB_Mode=1},tag=GB_knight] iron_sword[unbreakable={show_in_tooltip:false}]
item replace entity @a[scores={GB_Mode=1},tag=GB_knight] weapon.offhand with minecraft:shield[unbreakable={show_in_tooltip:false}]
