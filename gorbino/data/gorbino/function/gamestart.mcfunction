...
give @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_star] gold_nugget[custom_model_data={strings:['GB_Star']},custom_name=[{"text":"Star","italic":false}],food={can_always_eat:1b,nutrition:1,saturation:1},consumable={consume_seconds:0.05,has_consume_particles:0b},use_cooldown={seconds:60}]