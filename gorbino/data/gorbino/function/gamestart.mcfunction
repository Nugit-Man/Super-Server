...
execute in gorbino:game run execute if score GB_Map GB_Select matches 20 run worldborder center 20000.5 0.5
execute in gorbino:game run execute if score GB_Map GB_Select matches 21 run worldborder center 21000.5 0.5
execute in gorbino:game run execute if score GB_Map GB_Select matches 22 run worldborder center 22000.5 0.5
...
execute in gorbino:game run execute if score GB_Map GB_Select matches 22 run tp @a[scores={GB_Mode=1..,MAIN_Game=3}] 22000 2 0
...
give @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_dash] sugar[custom_name=[{text:"Dash",italic:false,color:"white"}],food={nutrition:0,saturation:0,can_always_eat:1b},consumable={consume_seconds:0.05,sound:"entity.armadillo.brush",has_consume_particles:0b},use_cooldown={seconds:3}]
...
execute as @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_grow] run attribute @s movement_speed base set 0.12
...
give @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_heal] red_dye[custom_name=[{text:"Heal",italic:false}],food={nutrition:0,saturation:0,can_always_eat:1b},consumable={consume_seconds:3,animation:brush,sound:"block.beacon.activate",has_consume_particles:0b},use_cooldown={seconds:30}]
...
execute as @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_Hazmat] run attribute @s armor base set -7
item replace entity @a[scores={GB_Mode=1,MAIN_Game=3},tag=GB_Hazmat] armor.head with leather_helmet[trim={pattern:sentry,material:netherite},dyed_color=16776960,custom_name=[{text:"Hazmat Suit",italic:false}],unbreakable={},tooltip_display={hidden_components:[attribute_modifiers,dyed_color,trim,unbreakable]},enchantment_glint_override=true,lore=[{text:"selected",italic:false,color:gray}]]
