...
item replace entity @a[scores={GB_Mode=1},tag=GB_simple_armor] armor.chest with minecraft:leather_chestplate[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_simple_armor] armor.legs with minecraft:leather_leggings[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_simple_armor] armor.feet with minecraft:leather_boots[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
#item replace entity @a[scores={GB_Mode=1},tag=GB_sneak] armor.legs with minecraft:leather_leggings[unbreakable={show_in_tooltip:false},enchantments={swift_sneak:3}]
item replace entity @a[scores={GB_Mode=1},tag=GB_chain_armor] armor.chest with minecraft:chainmail_chestplate[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_chain_armor] armor.legs with minecraft:chainmail_leggings[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_chain_armor] armor.feet with minecraft:chainmail_boots[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
#item replace entity @a[scores={GB_Mode=1},tag=GB_sneak] armor.legs with minecraft:chainmail_leggings[unbreakable={show_in_tooltip:false},enchantments={swift_sneak:3}]
item replace entity @a[scores={GB_Mode=1},tag=GB_heavy_armor] armor.chest with minecraft:iron_chestplate[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_heavy_armor] armor.legs with minecraft:iron_leggings[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_heavy_armor] armor.feet with minecraft:iron_boots[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
#execute as @a[tag=GB_heavy_armor] run item replace entity @s[scores={GB_Mode=1},tag=GB_sneak] armor.legs with minecraft:iron_leggings[unbreakable={show_in_tooltip:false},enchantments={swift_sneak:3}]
give @a[scores={GB_Mode=1},tag=GB_lumberjack] iron_axe[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
give @a[scores={GB_Mode=1},tag=GB_archer] bow[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
give @a[scores={GB_Mode=1},tag=GB_archer] arrow 8
scoreboard players set @a[scores={GB_Mode=1},tag=GB_archer] GB_Arrow 0
give @a[scores={GB_Mode=1},tag=GB_knight] iron_sword[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
item replace entity @a[scores={GB_Mode=1},tag=GB_knight] weapon.offhand with minecraft:shield[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
give @a[scores={GB_Mode=1},tag=GB_knockback] stick[custom_name=[{text:"Knockback Stick",italic: false}],enchantments={knockback:5}]
give @a[scores={GB_Mode=1},tag=GB_dash] sugar[custom_name=[{text:"Dash",italic:false}],consumable={nutrition:0,saturation:0,can_always_eat:1b,consume_seconds:0,sound:"entity.armadillo.brush",has_consume_particles:0b},use_cooldown={seconds:2}]
give @a[scores={GB_Mode=1},tag=GB_burst_charm] minecraft:nether_star[custom_name=[{text:"Burst Charm",italic:false}],consumable={nutrition:0,saturation:0,can_always_eat:1b,consume_seconds:1,animation:brush,sound:"block.amethyst_block.resonate",has_consume_particles:0b},use_cooldown={seconds:10}]
...
give @a[scores={GB_Mode=1},tag=GB_mace_master] mace[unbreakable={},tooltip_display={hidden_components:[unbreakable]}]
...
execute as @a[scores={GB_Mode=1},tag=GB_grow] run attribute @s minecraft:max_health base set 40
execute as @a[scores={GB_Mode=1},tag=GB_grow] run attribute @s minecraft:step_height base set 1
execute as @a[scores={GB_Mode=1},tag=GB_shrink] run attribute @s scale base set 0.6
execute as @a[scores={GB_Mode=1},tag=GB_shrink] run attribute @s jump_strength base set 0.4
execute as @a[scores={GB_Mode=1},tag=GB_shrink] run attribute @s entity_interaction_range base set 2
execute as @a[scores={GB_Mode=1},tag=GB_shrink] run attribute @s minecraft:max_health base set 14
effect give @a[scores={GB_Mode=1},tag=GB_shrink] speed infinite 4 true
execute as @a[scores={GB_Mode=1},tag=GB_grow] run advancement grant @s[tag=GB_shrink] only gorbino:size
#shotgun and super shotgun code need fixing
#give @a[scores={GB_Mode=1},tag=GB_shotgun] crossbow[custom_name=[{text: "Shotgun","bold": true,italic:false,"color":"red"}],charged_projectiles=[{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{flight_duration:1,explosions:[{shape:"large_ball",has_trail:true,colors:[I;3684408],fade_colors:[I;1644568]},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"},{shape:"small_ball"}]}}}],enchantments={levels:{"minecraft:multishot":1}},unbreakable={show_in_tooltip:false}] 1
#execute as @a[scores={GB_Mode=1},tag=GB_super_shotgun] run attribute @s max_health base set 2
#give @a[scores={GB_Mode=1},tag=GB_super_shotgun] crossbow[custom_name=[{text: "Shotgun","bold": true,italic:false,"color":"red"}],enchantments={levels:{"minecraft:multishot":1}},unbreakable={show_in_tooltip:false}] 1
#give @a[scores={GB_Mode=1},tag=GB_super_shotgun] firework_rocket[fireworks={flight_duration:1,explosions:[ ... truncated for brevity ... ]}]
give @a[scores={GB_Mode=1},tag=GB_invis] minecraft:glass_pane[custom_name=[{text:"Invisability",italic:false}],consumable={nutrition:0,saturation:0,can_always_eat:1b,consume_seconds:0,sound:"entity.enderman.teleport",has_consume_particles:0b},use_cooldown={seconds:25}]
give @a[scores={GB_Mode=1},tag=GB_laser] minecraft:honey_bottle[custom_name=[{text:"Super Laser Piss",italic:false}],consumable={nutrition:0,saturation:0,can_always_eat:1b,consume_seconds:0,sound:"block.beacon.activate",has_consume_particles:0b},use_cooldown={seconds:12}]
give @a[scores={GB_Mode=1},tag=GB_crack] minecraft:ghast_tear[custom_name=[{text:"Cocaine",italic:false}],consumable={nutrition:0,saturation:0,can_always_eat:1b,consume_seconds:0,sound:"entity.generic.eat",has_consume_particles:0b},use_cooldown={seconds:17}]
give @a[scores={GB_Mode=1},tag=GB_curry] minecraft:bowl[custom_name=[{text:"Curry",italic:false}],consumable={nutrition:0,saturation:0,can_always_eat:1b,consume_seconds:0,sound:"entity.generic.eat",has_consume_particles:0b},use_cooldown={seconds:0.2}]
