scoreboard players set @a[tag=!GB_Welcome] GB_Menu 0
scoreboard players set @a[tag=!GB_Welcome] GB_Mode 0
scoreboard players set @a[tag=!GB_Welcome] GB_Select 0
scoreboard players set @a[tag=!GB_Welcome] GB_Points 0
tag @a add GB_Welcome
...
execute as @a[scores={GB_Mode=1..,GB_Select=2}] run clear @s[scores={GB_Mode=1..}]
execute as @a[scores={GB_Mode=1..,GB_Select=2}] run scoreboard players set @s[scores={GB_Mode=1..}] GB_Menu 0
execute as @a[scores={GB_Mode=1..,GB_Select=2}] run scoreboard players set @s[scores={GB_Mode=1..}] GB_Mode 0
execute as @a[scores={GB_Mode=1..,GB_Select=2}] run scoreboard players set @s[scores={GB_Mode=1..}] GB_velocity 0
scoreboard players set @s[scores={GB_Mode=1..}] GB_Select 1
...
experience set @a[scores={GB_Points=0}] 0 points
experience set @a[scores={GB_Points=1}] 150 points
experience set @a[scores={GB_Points=2}] 300 points
experience set @a[scores={GB_Points=3}] 450 points
experience set @a[scores={GB_Points=4}] 600 points
experience set @a[scores={GB_Points=5}] 750 points
...
execute at @a[scores={GB_Mode=2..}] run fill ~20 ~9 ~20 ~-20 ~-9 ~-20 minecraft:stone replace minecraft:lava[level=0]
execute at @a[scores={GB_Mode=2..}] run fill ~20 ~9 ~20 ~-20 ~-9 ~-20 minecraft:air replace minecraft:lava
execute at @a[scores={GB_Mode=2..}] run fill ~20 ~-9 ~20 ~-20 ~-19 ~-20 minecraft:air replace minecraft:lava
execute at @a[scores={GB_Mode=2..}] run fill ~20 ~-19 ~20 ~-20 ~-39 ~-20 minecraft:air replace minecraft:lava
execute at @a[scores={GB_Mode=2..}] run fill ~20 ~-39 ~20 ~-20 ~-59 ~-20 minecraft:air replace minecraft:lava
execute at @a[scores={GB_Mode=2..}] run fill ~20 ~9 ~20 ~-20 ~-9 ~-20 minecraft:air replace minecraft:fire
