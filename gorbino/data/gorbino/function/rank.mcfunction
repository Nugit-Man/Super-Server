...
execute as @r[scores={GB_Rank=1}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_1] text set value ["1st: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=2}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_2] text set value ["2nd: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=3}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_3] text set value ["3rd: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=4}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_4] text set value ["4th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=5}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_5] text set value ["5th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=6}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_6] text set value ["6th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=7}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_7] text set value ["7th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=8}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_8] text set value ["8th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=9}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_9] text set value ["9th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]
execute as @r[scores={GB_Rank=10}] run execute in gorbino:lobby run data modify entity @e[type=text_display,limit=1,sort=arbitrary,tag=GB_10] text set value ["10th: ",{"selector":"@s"}," ",{"score":{"name":"@s","objective":"GB_Milestones_Wins"}}]