...
execute at @e[tag=burst_charm,type=armor_stand] run damage @a[distance=..2.5,limit=1,sort=nearest,tag=!GB_Hazmat] 12 magic by @s
execute at @e[tag=burst_charm,type=armor_stand] run damage @a[distance=..2.5,limit=1,sort=nearest,tag=GB_Hazmat] 6 magic by @s
