...
execute positioned ^ ^ ^2 as @s run damage @r[distance=..1.5,tag=GB_Hazmat] 6 in_fire
execute positioned ^ ^ ^2 as @s run damage @r[distance=..1.5,tag=!GB_Hazmat] 3 in_fire
