...
item replace entity @s[advancements={final_island:star=true},tag=!GB_star] inventory.1 with minecraft:gold_nugget[custom_model_data={strings:['GB_Star']},custom_name=[{text:"Star [2]",italic:false}],lore=[{text:"Makes you invinceable for 12 seconds",color:dark_gray},{text:"Very long cooldown",color:dark_gray}]]
...
item replace entity @s[advancements={gorbino:hazmat=true},tag=!GB_Hazmat] inventory.2 with leather_chestplate[trim={pattern:sentry,material:netherite},dyed_color=16776960,custom_name=[{text:"Hazmat Suit",italic:false}],unbreakable={},tooltip_display={hidden_components:[attribute_modifiers,dyed_color,trim,unbreakable]},lore=[{text:"Greatly reduces damage from spells",color:dark_gray},{text:"Does minimal protection form spells",color:dark_gray}]]
...
#item replace entity @s[tag=!GB_Piss] inventory.4 with minecraft:honey_bottle[custom_name={text:"Super Laser Piss [2]",italic:false},lore=[{text:"Shoot a gain laser of piss",color:dark_gray},{text:"Poinsons victums",color:dark_gray},{text:"Can go through walls",color:dark_gray}]]
...
execute if score @s[tag=GB_Hazmat] GB_Select matches 2 run tag @s add GB_check
execute if score @s[tag=GB_check] GB_Select matches 2 run tag @s remove GB_Piss
execute if score @s[tag=GB_check] GB_Select matches 2 run scoreboard players remove @s GB_Points 2
execute if score @s[tag=!GB_check] GB_Select matches 2 run tag @s[scores={GB_Points=4..}] add GB_check
execute if score @s[tag=!GB_check] GB_Select matches 2 run scoreboard players add @s GB_Points 2
execute if score @s[tag=!GB_check] GB_Select matches 2 run tag @s add GB_Piss
tag @s remove GB_check
execute if score @s GB_Select matches 2 run clear @s
scoreboard players set @s GB_Select 1